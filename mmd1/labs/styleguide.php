...
<div id="maincontainer">
	<div id="contentmain">
		<h2 id="page_title"><a href="../index.php">HOME</a> > <a href="https://docs.google.com/document/d/1x7inUlMzSNkRsw2x4ZdQ429gNKWTBQw5FIMLakxbOE4/edit?usp=sharing" target="_blank">Lab 9: Style Guide</a></h2>
		...
		<div id="accordion">
			...
			<div class="sectioncontent">
				...
				<div class="feedback">
					<ul>
						<li><input type="checkbox" value="0"> Photoshop document was not named correctly.</li>
						<li><input type="checkbox" value="0"> File format was incorrect.</li>
					</ul>
			...
			<div class="sectioncontent">
				...
				<div class="feedback">
					<ul>
						<li><input type="checkbox" value="0"> Layers must be grouped into top and sub level groups.</li>
			...
			<div class="sectioncontent">
				...
				<div class="feedback">
					<ul>
						...
						<li><input type="checkbox" value="0"> Incorrect document resolution.</li>
						<li><input type="checkbox" value="0"> Color palette is not present.</li>
						<li><input type="checkbox" value="0"> Typography samples are not present.</li>
						<li><input type="checkbox" value="0"> Correct logo use is not present.</li>
						<li><input type="checkbox" value="0"> Incorrect logo use is not present.</li>
					</ul>
					<h4>Additional Comments</h4>
					<p><textarea class="commentSection" rows="4" cols="75"></textarea></p>
				</div>
			...
			<div class="sectioncontent">
				...
				<div class="group feedback">
					...
					<ul>
						...
						<li><input type="checkbox" value="0"> Incorrect inclusion of Illustrator art.</li>
					</ul>
			...
			<div class="sectioncontent">
				...
				<div class="group feedback">
					<ul>
						<li><input type="checkbox" value="0"> Elements do not support the brand.</li>
						...
						<li><input type="checkbox" value="0"> Incorrect use of composition and grouping principles.</li>
					</ul>
					<ul>

...
<div id="maincontainer">
	<div id="contentmain">
		<h2 id="page_title"><a href="../index.php">HOME</a> > <a href="https://docs.google.com/document/d/152ArgKbs1RM9FJgH5FPFuG_fzABO5nX2ewO9joyhbz4/edit?usp=sharing" target="_blank">Lab 6: Photoshop Effects</a></h2>
		<div class="divider"></div>
		<div id="accordion">
			<h3 class="sectiontitle">Original Image</h3>
			<div class="sectioncontent">
				...
				<div class="feedback">
					<ul>
						<li><input type="checkbox" value="0"> Original image is missing.</li>
					</ul>
					<h4>Additional Comments</h4>
					<p><textarea class="commentSection" rows="4" cols="75"></textarea></p>
				</div>
			</div>
			<h3 class="sectiontitle">Modified Image</h3>
			<div class="sectioncontent">
				<table class="points25">
					<tr>
						<td><abbr title="Comprehensive and in-depth understanding of the subject matter. Can provide sophisticated solutions to complex problems."><span style="text-decoration:underline;">A+</span></abbr></td>
				...
				<div class="feedback">
					<ul>
						<li><input type="checkbox" value="0"> Modified image is missing.</li>
					</ul>
					<h4>Additional Comments</h4>
					<p><textarea class="commentSection" rows="4" cols="75"></textarea></p>
				</div>
			</div>
			<h3 class="sectiontitle">Effect</h3>
			<div class="sectioncontent">
				<table class="points50">
					<tr>
						<td><abbr title="Comprehensive and in-depth understanding of the subject matter. Can provide sophisticated solutions to complex problems."><span style="text-decoration:underline;">A+</span></abbr></td>
						<td><abbr title="Solid understanding of challenging subject matter. Can solve a wide variety of problems."><span style="text-decoration:underline;">A</span></abbr></td>
						<td><abbr title="Understanding of some challenging subject matter. Can solve simple problems."><span style="text-decoration:underline;">B</span></abbr></td>
				...
				<div class="feedback">
					<ul>
						<li><input type="checkbox" value="0"> Photoshop effect was not used to modify image.</li>
						<li><input type="checkbox" value="0"> Photoshop tools were not used correctly.</li>
					</ul>
					<h4>Additional Comments</h4>
					<p><textarea class="commentSection" rows="4" cols="75"></textarea></p>
				</div>

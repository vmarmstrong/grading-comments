...
<div id="maincontainer">
	<div id="contentmain">
		<h2 id="page_title"><a href="../index.php">HOME</a> > <a href="https://docs.google.com/document/d/1EC4hi85qsv9deVMJqV8t1HG7odughn6B3ZZaegzYsrQ/edit?usp=sharing" target="_blank">Lab 4: Psychology of Brands</a></h2>
		...
		<div id="accordion">
			...
			<div class="sectioncontent">
				...
				<div class="feedback">
					<ul>
						<li><input type="checkbox" value="0"> Documents are missing.</li>
					</ul>
					<h4>Additional Comments</h4>
					<p><textarea class="commentSection" rows="4" cols="75"></textarea></p>
				</div>
			</div>
			<h3 class="sectiontitle">Legends</h3>
			<div class="sectioncontent">
				...
				<div class="feedback">
					<ul>
						<li><input type="checkbox" value="0"> Legends are missing.</li>
					</ul>
					<h4>Additional Comments</h4>
					<p><textarea class="commentSection" rows="4" cols="75"></textarea></p>
				</div>
			...
			<div class="sectioncontent">
				...
				<div class="feedback">
					<ul>
						<li><input type="checkbox" value="0"> Document was not well organized.</li>
					</ul>
					<h4>Additional Comments</h4>
					<p><textarea class="commentSection" rows="4" cols="75"></textarea></p>
				</div>

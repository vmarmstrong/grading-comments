...
<div id="maincontainer">
	<div id="contentmain">
		<h2 id="page_title"><a href="../index.php">HOME</a> > <a href="https://docs.google.com/document/d/1E65qSD7WjyrN14AiV02QhU5Bb-MjRfklz0akA0favqs/edit?usp=sharing" target="_blank">Discussion 3: Responsive Design</a></h2>
		<div class="divider"></div>
		<div id="accordion">
			<h3 class="sectiontitle">Requirements</h3>
			<div class="sectioncontent">
				<table class="points60">
					<tr>
				...
				<div class="feedback">
					<ul>
						<li><input type="checkbox" value="0"> Questions were answered.</li>
					</ul>
			...
			<div class="sectioncontent">
				...
				<div class="group feedback">
					<ul>
						<li><input type="checkbox" value="0"> Written post was not well organized.</li>

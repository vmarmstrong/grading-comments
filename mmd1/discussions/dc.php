...
<div id="maincontainer">
	<div id="contentmain">
		<h2 id="page_title"><a href="../index.php">HOME</a> > <a href="https://docs.google.com/document/d/1gYCKLEYSyObnuvWok8mFj3K-NbfpRo786PncpaH54TY/edit?usp=sharing" target="_blank">Discussion 2: Design Critique</a></h2>
		<div class="divider"></div>
		<div id="accordion">
			<h3 class="sectiontitle">Moodboard Image</h3>
			<div class="sectioncontent">
				<table class="points20">
					...
					<tr>
						...
						<td><input type="radio" name="radio1" value=".9"></td>
						<td><input type="radio" name="radio1" value=".8"></td>
				...
				<div class="feedback">
					<ul>
						<li><input type="checkbox"> Moodboard should be included in initial post.</li>
						<li><input type="checkbox"> Moodboard should be an embedded image file (jpeg or png).</li>
						<li><input type="checkbox"> Photoshop document was posted.</li>
					</ul>
					<h4>Additional Comments</h4>
					<p><textarea class="commentSection" rows="4" cols="75"></textarea></p>
				</div>
			</div>
			<h3 class="sectiontitle">Explanation</h3>
			<div class="sectioncontent">
				<table class="points20">
					<tr>
						<td><abbr title="Comprehensive and in-depth understanding of the subject matter. Can provide sophisticated solutions to complex problems."><span style="text-decoration:underline;">A+</span></abbr></td>
					...
					<tr>
						...
						<td><input type="radio" name="radio2" value=".9"></td>
						<td><input type="radio" name="radio2" value=".8"></td>
				...
				<div class="feedback">
					<ul>
						<li><input type="checkbox"> An explanation of design choices made was required in the initial post.</li>
					</ul>
					<h4>Additional Comments</h4>
					<p><textarea class="commentSection" rows="4" cols="75"></textarea></p>
				</div>
			...
			<div class="sectioncontent">
				...
				<div class="feedback">
					<ul>
						<li><input type="checkbox"> One of three comments were made.</li>
						<li><input type="checkbox"> Two of three comments were made.</li>
						<li><input type="checkbox"> Constructive criticism should offer valid and well-reasoned opinions about the work of others, usually involving both positive and negative comments, in a friendly manner.</li>
						<li><input type="checkbox"> The purpose of constructive criticism is to improve the outcome of another's work.</li>
					</ul>
					<h4>Additional Comments</h4>
					<p><textarea class="commentSection" rows="4" cols="75"></textarea></p>
				</div>

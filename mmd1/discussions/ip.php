...
<div id="maincontainer">
	<div id="contentmain">
		<h2 id="page_title"><a href="../index.php">HOME</a> > <a href="https://docs.google.com/document/d/13S4H-Dnrtx4_Wy99kF3h9UPz_fT0NpplUsiS1eKnMSg/edit?usp=sharing" target="_blank">Discussion 1: Intellectual Property</a></h2>
		<div class="divider"></div>
		<div id="accordion">
			<h3 class="sectiontitle">Topic</h3>
			<div class="sectioncontent">
				...
				<div class="feedback">
					<ul>
						<li><input type="checkbox" value="0"> Question was not answered.</li>
					</ul>
					<h4>Additional Comments</h4>
					<p><textarea class="commentSection" rows="4" cols="75"></textarea></p>
				</div>
			</div>
			<h3 class="sectiontitle">Citation</h3>
			<div class="sectioncontent">
				...
				<div class="group feedback">
					<ul>
						<li><input type="checkbox" value="0"> APA citation was not provided.</li>
					</ul>
					<h4>Additional Comments</h4>
					<p><textarea class="commentSection" rows="4" cols="75"></textarea></p>
				</div>
			</div>
			<h3 class="sectiontitle">Topic relevance</h3>
			<div class="sectioncontent">
				<table class="points30">
					<tr>
						<td><abbr title="Comprehensive and in-depth understanding of the subject matter. Can provide sophisticated solutions to complex problems."><span style="text-decoration:underline;">A+</span></abbr></td>
				...
				<div class="group feedback">
					<ul>
						<li><input type="checkbox" value="0"> Relevance to industry was not established.</li>
					</ul>
					<h4>Additional Comments</h4>
					<p><textarea class="commentSection" rows="4" cols="75"></textarea></p>
				</div>
			...
			<div class="sectioncontent">
				...
				<div class="group feedback">
					<ul>
						<li><input type="checkbox" value="0"> Post was not well organized.</li>
						<li><input type="checkbox" value="0"> Written post does not use proper grammar and/or punctuation.</li>
						<li><input type="checkbox" value="0"> Video was not within the required length.</li>
					</ul>
					<h4>Additional Comments</h4>
					<p><textarea class="commentSection" rows="4" cols="75"></textarea></p>
				</div>
